...
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/favorites/_page.svelte.js')).default;
...
export const stylesheets = ["_app/immutable/assets/8.gUjhRS5y.css"];
export const fonts = [];
